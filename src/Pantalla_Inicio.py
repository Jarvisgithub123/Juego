...
pygame.mixer.music.load("Assets\Music\wwd.mp3juice.blog - Aventura - Los Infieles (192 KBps).mp3")
pygame.mixer.music.play(-1)  # Reproducir en bucle
sonido_boton=pygame.mixer.Sound("Assets\Music\mixkit-arcade-game-jump-coin-216.mp3")
